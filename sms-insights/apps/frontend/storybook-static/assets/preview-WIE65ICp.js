...
var I = 'storybook/actions',
  ...
  V = (e) => {
    if (j(e)) {
      ...
      t.persist();
      const n = Object.getOwnPropertyDescriptor(t, 'view'),
        r = n?.value;
      return (
        typeof r == 'object' &&
  ...
  const n = { ...U, ...t },
    r = (...s) => {
      if (t.implicit) {
        ...
        if (g) {
          const l = !globalThis?.FEATURES?.disallowImplicitActionsInRenderV8,
            O = new w({ phase: g.phase, name: e, deprecated: l });
          if (l) console.warn(O);
          else throw O;
        }
      }
      const o = D.getChannel(),
        c = C(),
        a = 5,
        u = s.map(V),
        E = s.length > 1 ? u : u[0],
...
var m = (e, t) => typeof t[e] > 'u' && !(e in t),
  K = (e) => {
    ...
    const o = new RegExp(s.argTypesRegex);
  ...
  B = (e) => {
    ...
    if (
      ...
      const n = p.__STORYBOOK_TEST_ON_MOCK_CALL__;
      n((r, s) => {

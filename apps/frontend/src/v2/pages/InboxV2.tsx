...
export default function InboxV2() {
  ...
  const localObjectionTags = inboxState.selectionState.localObjectionTags;
  const localCallOutcome = inboxState.selectionState.localCallOutcome;
  ...
  useHotkeys(
    'mod+shift+s',
    (event) => {
      const currentConversationId = uiState.selectedConversationId;
      if (!uiState.isComposerModalOpen || !currentConversationId) return;
      event.preventDefault();
      ...
      <div className="V2Inbox__filterBar">
        <div className="V2Inbox__filterGroup">
          <button
            ...
            onClick={() =>
              updateFilters({
                statusFilter: filters.statusFilter === 'open' ? '' : 'open',
              })
            }
          >
            <span
          ...
          <button
            ...
            onClick={() =>
              updateFilters({
                statusFilter: filters.statusFilter === 'closed' ? '' : 'closed',
              })
            }
          >
            <span
          ...
          <button
            ...
            onClick={() =>
              updateFilters({
                statusFilter: filters.statusFilter === 'dnc' ? '' : 'dnc',
              })
            }
          >
            <span
        ...
        <div className="V2Inbox__filterGroup">
          <button
            ...
            onClick={() =>
              updateFilters({
                ownerFilter: filters.ownerFilter === 'jack' ? 'all' : 'jack',
              })
            }
          ...
          <button
            ...
            onClick={() =>
              updateFilters({
                ownerFilter:
                  filters.ownerFilter === 'brandon' ? 'all' : 'brandon',
              })
            }
          ...
          <button
            ...
            onClick={() =>
              updateFilters({
                ownerFilter:
                  filters.ownerFilter === 'unassigned' ? 'all' : 'unassigned',
              })
            }
          >
      ...
      >
        <AlertDialog.Portal>
          ...
          >
            ...
            >
              You&apos;re sending a call link at L{escalationState.level}.
              Confirm at least 2 buying signals before proceeding.
            </AlertDialog.Description>

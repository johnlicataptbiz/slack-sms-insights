          ...
          <div className="SalesTrend__bars">
            <div className="SalesTrend__line">
              ...
              <div className="SalesTrend__track">
                <div
                  className="SalesTrend__fill SalesTrend__fill--sent"
                  style={{ width: `${scale(p.messagesSent, maxSent)}%` }}
                />
              </div>
            ...
            <div className="SalesTrend__line">
              ...
              <div className="SalesTrend__track">
                <div
                  className="SalesTrend__fill SalesTrend__fill--booked"
                  style={{ width: `${scale(p.booked, maxBooked)}%` }}
                />
              </div>

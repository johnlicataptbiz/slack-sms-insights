...
fs.writeFileSync(
  path.join('frontend', 'src', 'styles', 'tokens.generated.css'),
  outCss,
  'utf-8',
);
fs.writeFileSync(
  path.join('frontend', 'src', 'styles', 'design-system.tokens.json'),
  JSON.stringify(tokens, null, 2),
  'utf-8',
);

console.log(
  '✅ Generated tokens: frontend/src/styles/tokens.generated.css and design-system.tokens.json',
);

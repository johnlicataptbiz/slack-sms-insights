import { c as l } from './client-Dmhp9b6n.js';
import { r as s } from './index-yRop1keA.js';
var n = new Map();
function m() {
...
var E = async (e, r, t) => {
    ...
    const { promise: u, resolve: i } = Promise.withResolvers();
...
export { E as renderElement, v as unmountElement };

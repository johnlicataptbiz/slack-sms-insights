...
export async function listContactActivities(contactKey: string, limit = 50, offset = 0): Promise<ContactActivityRow[]> {
...
export async function getContactActivityStats(contactKey: string): Promise<{

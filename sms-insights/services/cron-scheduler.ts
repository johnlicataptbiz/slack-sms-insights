...
import { quickAlertCheck, postProactiveAlert, shouldSendAlert } from "./proactive-alerts.js";
...
const ALERTS_WEBHOOK_URL =
  process.env.ALERTS_WEBHOOK_URL || "http://localhost:3000/api/alerts/webhook";

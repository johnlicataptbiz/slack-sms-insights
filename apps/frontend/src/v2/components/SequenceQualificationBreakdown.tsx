        ...
        {!isExpanded && (
          <div className="SequenceCard__summary">
            ...
            <span className="SequenceCard__summaryItem" title="Revenue Model">
              {dominantRevenue}{' '}
              {(dominantRevenue === 'Cash'
                ? item.mostlyCash.pct
                : dominantRevenue === 'Insurance'
                  ? item.mostlyInsurance.pct
                  : dominantRevenue === 'Mixed'
                    ? item.balancedMix.pct
                    : 0
              ).toFixed(0)}
              %
            </span>
  ...
  if (items.length === 0) {
    return (
      <V2Panel
        ...
        caption="Self-identified lead attributes from qualification inference"
      >

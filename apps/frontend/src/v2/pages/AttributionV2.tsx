...
export default function AttributionV2() {
  ...
  if (isError || !payload) {
    return (
      <V2State kind="error">
        Could not load booking source details: {String((error as Error)?.message || error)}
      </V2State>
    );
  }
  ...
  return (
    <div className="V2Page V2PageTransition V2Page--clean">
      <V2PageHeader title={v2Copy.nav.attribution} subtitle="See where your booked calls are coming from." />

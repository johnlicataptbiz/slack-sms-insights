...
export const useV2UpdateQualification = () => {
  ...
  return useMutation({
    mutationFn: async (params: {
      ...
      return client.post<ApiEnvelope<QualificationStateV2>>(
        `/api/v2/inbox/conversations/${params.conversationId}/qualification`,
        {
...
export const useV2OverrideEscalation = () => {
  ...
  return useMutation({
    mutationFn: async (params: {
      ...
      return client.post<ApiEnvelope<unknown>>(
        `/api/v2/inbox/conversations/${params.conversationId}/escalation-override`,
        {
          level: params.level,

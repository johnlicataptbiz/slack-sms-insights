                ...
                <div className="table-container">
                  <table className="metrics-table">
                    <thead>
                      <tr>
                        <th>
                          <button className="sortable" onClick={() => handleSort('label')} type="button">
                            Sequence {getSortIndicator('label')}
                          </button>
                        </th>
                        <th>
                          <button className="sortable" onClick={() => handleSort('messagesSent')} type="button">
                            Sent {getSortIndicator('messagesSent')}
                          </button>
                        </th>
                        <th>
                          <button className="sortable" onClick={() => handleSort('repliesReceived')} type="button">
                            Replies {getSortIndicator('repliesReceived')}
                          </button>
                        </th>
                        <th>
                          <button className="sortable" onClick={() => handleSort('replyRate')} type="button">
                            Reply Rate {getSortIndicator('replyRate')}
                          </button>
                        </th>
                        <th>
                          <button className="sortable" onClick={() => handleSort('booked')} type="button">
                            Booked {getSortIndicator('booked')}
                          </button>
                        </th>
                        <th>
                          <button className="sortable" onClick={() => handleSort('optOuts')} type="button">
                            Opt-Outs {getSortIndicator('optOuts')}
                          </button>
                        </th>
                        <th>Risk Level</th>
                      </tr>

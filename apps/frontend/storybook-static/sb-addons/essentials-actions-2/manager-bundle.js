  ...
  (() => {
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Array) {
          if ((n = e.length) === t.length) while (n-- && L(e[n], t[n]));
          return n === -1;
        }
        if (r === Set) {
    ...
    function We(e) {
      ...
      var t = e.match(pt);
      return t ? Number.parseFloat(e) : e;
    }
    var ft = (t) => (r, n) => {
        n === void 0 && (n = '16px');
        var a = r,
    ...
    function I(e) {
      ...
      if (i)
        return {
          red: Number.parseInt('' + i[1], 10),
          green: Number.parseInt('' + i[2], 10),
          blue: Number.parseInt('' + i[3], 10),
          alpha:
            Number.parseFloat('' + i[4]) > 1
              ? Number.parseFloat('' + i[4]) / 100
              : Number.parseFloat('' + i[4]),
        };
      var s = Ot.exec(t);
      if (s) {
        var l = Number.parseInt('' + s[1], 10),
          u = Number.parseInt('' + s[2], 10) / 100,
          c = Number.parseInt('' + s[3], 10) / 100,
          p = 'rgb(' + F(l, u, c) + ')',
          d = re.exec(p);
      ...
      if (f) {
        var E = Number.parseInt('' + f[1], 10),
          m = Number.parseInt('' + f[2], 10) / 100,
          y = Number.parseInt('' + f[3], 10) / 100,
          O = 'rgb(' + F(E, m, y) + ')',
          w = re.exec(O);
        if (!w) throw new _(4, t, O);
        return {
          red: Number.parseInt('' + w[1], 10),
          green: Number.parseInt('' + w[2], 10),
          blue: Number.parseInt('' + w[3], 10),
          alpha:
    ...
    function Lt(e, t) {
      ...
      var r = A(t);
      return C(T({}, r, { hue: r.hue + Number.parseFloat(e) }));
    }
    var gl = v(Lt);
    function D(e, t, r) {
    ...
    function It(e, t) {
      ...
      var r = A(t);
      return C(
        T({}, r, { lightness: D(0, 1, r.lightness - Number.parseFloat(e)) }),
      );
    }
    var bl = v(It);
    function Dt(e, t) {
      ...
      var r = A(t);
      return C(
        T({}, r, { saturation: D(0, 1, r.saturation - Number.parseFloat(e)) }),
      );
    }
    var hl = v(Dt);
    function Mt(e, t) {
    ...
    function Pt(e, t, r) {
      ...
      var n = I(t),
        ...
        E = {
          ...
          alpha:
            a.alpha * Number.parseFloat(e) +
            s.alpha * (1 - Number.parseFloat(e)),
        };
      return $(E);
    }
    var Bt = v(Pt),
    ...
    function Ft(e, t) {
      ...
      var r = I(t),
        ...
        a = T({}, r, {
          alpha: D(0, 1, (n * 100 + Number.parseFloat(e) * 100) / 100),
        });
      return $(a);
    }
    var Ht = v(Ft),
    ...
    function Ut(e, t) {
      return t === 'transparent'
        ? t
        : C(T({}, A(t), { hue: Number.parseFloat(e) }));
    }
    var Ol = v(Ut);
    function jt(e, t) {
      return t === 'transparent'
        ? t
        : C(T({}, A(t), { lightness: Number.parseFloat(e) }));
    }
    var Tl = v(jt);
    function kt(e, t) {
      return t === 'transparent'
        ? t
        : C(T({}, A(t), { saturation: Number.parseFloat(e) }));
    }
    var _l = v(kt);
    function Gt(e, t) {
      return t === 'transparent'
        ? t
        : Je(Number.parseFloat(e), 'rgb(0, 0, 0)', t);
    }
    var vl = v(Gt);
    function Wt(e, t) {
      return t === 'transparent'
        ? t
        : Je(Number.parseFloat(e), 'rgb(255, 255, 255)', t);
    }
    var Sl = v(Wt);
    function Vt(e, t) {
      if (t === 'transparent') return t;
    ...
    var $t = 'actions',
      ...
      tr = fe({
        'node_modules/is-object/index.js'(e, t) {
          t.exports = (r) => typeof r == 'object' && r !== null;
        },
      }),
      rr = fe({
        ...
        TreeNode: {
          ...
          treeNodeArrow: {
            base: {
              ...
              fontSize: e.ARROW_FONT_SIZE,
              marginRight: e.ARROW_MARGIN_RIGHT,
              ...(Number.parseFloat(e.ARROW_ANIMATION_DURATION) > 0
                ? {

...
export function CommandPalette({ onSignOut, open: controlledOpen, onOpenChange }: Props) {
  ...
  const commands: CommandItem[] = [
    ...
    },
    {
      ...
      group: 'Navigate',
      action: () => go('/v2/inbox'),
      keywords: ['messages', 'conversations', 'sms'],
    },
    {
      id: 'nav-runs',
    ...
    },
    {
      ...
      icon: 'J',
      group: 'Navigate',
      action: () => go('/v2/insights?rep=jack'),
      keywords: ['jack', 'rep', 'scorecard'],
    },
    {
      id: 'nav-brandon',
      label: 'Insights: Brandon',
      icon: 'B',
      group: 'Navigate',
      action: () => go('/v2/insights?rep=brandon'),
    ...
    },
    {
      ...
      icon: '⟐',
      group: 'Navigate',
      action: () => go('/v2/sequences'),
      keywords: ['sequences', 'qualification', 'campaigns'],
    },
    {
      id: 'nav-attribution',
      label: 'Booking Audit',
      icon: '⊕',
      group: 'Navigate',
      action: () => go('/v2/attribution'),
      keywords: ['booking', 'source', 'attribution'],
    },
    // Actions
    {
      id: 'action-signout',
